from sqlalchemy import Column, Integer, Float, String, ForeignKey, Table, DateTime, Boolean, func, Text, Index
...
class ShoppingItem(Base):
    ...
    item_code = Column(String(50), ForeignKey("items.item_code"), nullable=True, index=True)  # Government item code
    ...
    item = relationship("Item", back_populates="shopping_items", foreign_keys=[item_code])
